...
const paresToDate = (str) => (new Date(str.replace(/年|月/g,'-').replace('日','').replace(/-([0-9])-/,'-0$1-').replace(/-([0-9])$/,'-0$1') + 'T00:00:00'))
